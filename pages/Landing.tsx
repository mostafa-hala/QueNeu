...
/>
      ...
      <main>
        <section id={Section.Home}><Hero lang={lang} t={t.hero} /></section>
        <section id={Section.About}><About lang={lang} t={t.about} /></section>

        <WisdomDemo lang={lang} t={t.demo} />

        <section id={Section.Solutions}><Solutions lang={lang} t={t.solutions} /></section>
        <section id={Section.GameSystem}><GameSystem lang={lang} t={t.gameSystem} /></section>
        {/* <section id={Section.Technology}><Technology lang={lang} t={t.tech} /></section> */}
        <section id={Section.Contact}><Contact lang={lang} t={t.contact} /></section>
      </main>
